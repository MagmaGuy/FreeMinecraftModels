...
public class PickupablePropConfig extends PropScriptLuaConfigFields {
    ...
    public String getSource() {
        return """
                local function can_bypass_region_protection(context)
                ...
                local function is_blocked(context)
                    ...
                    if loc and not can_bypass_region_protection(context)
                            and (em.location.is_protected(loc) or em.location.is_in_dungeon(loc)) then
