...
public class BoneTransforms {
    ...
    private final TransformationMatrix entityMatrix = new TransformationMatrix();
    @Getter
    ...
    public void updateBoneMatrix() {
        ...
        // Invert Y axis for default rotation
        Vector3f originalRotation = bone.getBoneBlueprint().getBlueprintOriginalBoneRotation();
        boneMatrix.rotateLocal(
                -originalRotation.get(0), // Invert X axis for default rotation
                -originalRotation.get(1), // Invert Y axis for default rotation
                originalRotation.get(2)   // Z is correct
        );

        // Invert X axis for animation rotation
        boneMatrix.rotateLocal(
                -bone.getAnimationRotation().get(0), // Invert X axis for animation
                bone.getAnimationRotation().get(1),  // Y animation direction is correct
                bone.getAnimationRotation().get(2)   // Z is correct
        );

        // Rest of the method unchanged
        // 3. Scale
        boneMatrix.scale(getDisplayEntityScale() / 2.5f);
